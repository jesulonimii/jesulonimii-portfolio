...
const CustomButton = (props: CustomButtonProps) => {
	...
	const classes = twMerge(
		...
		} py-3 px-4 font-[500] flex justify-center items-center gap-1 text-[12px] cursor-pointer rounded-lg font-outfit relative overflow-hidden capitalize transition duration-500 disabled:cursor-not-allowed ${className}`
	);
