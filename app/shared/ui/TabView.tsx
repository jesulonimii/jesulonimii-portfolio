		...
		<ThemeProvider theme={MuiTheme}>
			...
			<div className={twMerge(`w-full ${className}`)}>
				<div
					className={`${
						sticky && `sticky top-0`
					} dark:bg-bg-dark border-bg-50 dark:border-bg-dark-50 z-[4000] flex border-b bg-white capitalize ${
					...
					<Tabs
						...
						{tabList.map((tab, index) => {
							return (
								<Tab
									key={index}
									className={`text-gray-600 ${!uppercaseLabels && "text-md font-outfit capitalize"}`}
