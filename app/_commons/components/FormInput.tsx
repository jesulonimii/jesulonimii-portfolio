...
export const textFieldStyle = `bg-white border-outline dark:border-gray-500/40 my-2  autofill:bg-gray-500 p-4 outline-0 focus:ring-1  ring-secondary transition-200 bg-opacity-20 rounded-lg w-full`
...
const FormInput = (props: FormInputProps) => {
	...
	const textFieldClass = `${textFieldStyle} ${Object.keys(errors)?.length > 0 ? "border-red-400 ring-red-400" : ""} font-heading text-black dark:text-white ${startIcon && "pl-12"} ${
		endIcon && "pr-12"
	} bg-transparent`
