...
const CustomButton = (props: CustomButtonProps) => {
	...
	const styling = {
		...
		outlined: "text-black dark:text-gray-400 border border-outline dark:border-outline-dark hover:ring-2 px-4",
	...
	const classes = twMerge(
		`${styling} py-3 px-6 font-[500]  h-fit flex justify-center items-center gap-1 cursor-pointer rounded-lg font-heading relative overflow-hidden transition duration-500 ${className} ${(disabled === true) && "cursor-not-allowed bg-gray-700 text-white opacity-50"}`,
	)
